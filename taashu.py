...
# The Greeting
print(items + ' ' * 67 + 'I LOVE YOU !' + ' ' * 65 + reversed_items)
...
# Line 9
print(items + ' ' * 22 + items * 27 + 'x' + ' T ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 10
print(items + ' ' * 22 + items * 27 + 'x' + ' A ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 11
print(items + ' ' * 22 + items * 27 + 'x' + ' A ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 12
print(items + ' ' * 22 + items * 27 + 'x' + ' S ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 13
print(items + ' ' * 22 + items * 27 + 'x' + ' H ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 14
print(items + ' ' * 22 + items * 27 + 'x' + ' U ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 15
print(items + ' ' * 22 + items * 27 + 'x' + ' & ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 16
print(items + ' ' * 22 + items * 27 + 'x' + ' B ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 17
print(items + ' ' * 22 + items * 27 + 'x' + ' A ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
# Line 18
print(items + ' ' * 22 + items * 27 + 'x' + ' B ' + items * 27 + 'x' + ' ' * 20 + reversed_items)
